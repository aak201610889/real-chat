...
">
      ...
      <form action="" onSubmit={Submit} className="lg:w-[55%] md:w-[55%] sm:w-[80%] lg:bg-white md:bg-white h-[100%]   rounded-r-2xl  ">
        ...
        <input type="text" className="block border-[#5aca50] border-[3px] py-[1%] m-auto mt-[15%] lg:w-[80%] md:w-[80%] w-[95%] lg:text-3xl md:text-2xl text-xl placeholder:text-[#7AC973]  capitalize pl-[3%]  h-[50px]  rounded-3xl" value={user.name}  onChange={changeInput} placeholder="name" name="name"/>
        <input type="text" className="block border-[#5aca50] border-[3px] py-[1%] m-auto mt-[7%] lg:w-[80%] md:w-[80%] w-[95%] lg:text-3xl md:text-2xl text-xl placeholder:text-[#7AC973]  capitalize pl-[3%]  h-[50px] rounded-3xl" value={user.email}  onChange={changeInput} placeholder="email" name="email"/>
        ...
        <input type="text" className="block border-[#5aca50] border-[3px] py-[1%] m-auto mt-[7%] lg:w-[80%] md:w-[80%] w-[95%] lg:text-3xl md:text-2xl text-xl placeholder:text-[#7AC973]  capitalize pl-[3%]  h-[50px] rounded-3xl" value={user.confirmPassword}  onChange={changeInput} placeholder="confirm password" name="confirmPassword"/>
